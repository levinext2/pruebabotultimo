...
def createDownloading(filename,totalBits,currentBits,speed,time,tid=''):
    ...
    msg+= '🕰️Tiempo: ' + str(datetime.timedelta(seconds=int(time))) +'\n\n'
...
def createUploading(filename,totalBits,currentBits,speed,time,originalname=''):
    ...
    msg+= '》Tamaño Total: ' + str(sizeof_fmt(totalBits))+'\n'
    msg+= '🗞️Subido: ' + str(sizeof_fmt(currentBits))+'\n'
    msg+= 'Velocidad: ' + str(sizeof_fmt(speed))+'/s\n'
    msg+= '🕰️Tiempo: ' + str(datetime.timedelta(seconds=int(time))) +'\n'

    msg = '📤Subiendo A La Nube☁...\n\n'
    msg += '🏷️Nombre: '+filename+'\n'
    if originalname!='':
        msg = str(msg).replace(filename,originalname)
...
def createStat(username,userdata,isadmin):
    ...
    msg+= '🗳️Password: ' + str(userdata['moodle_password'])+'\n'
